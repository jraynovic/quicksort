function partition(arr, start, end) {
  ...
  function quickSort(array, start = 0, end = array.length - 1) {
    ...
    quickSort(array, start, pivotIndex - 1)// Left run quicksort on array from start up to but NOT including pivot index
    
    quickSort(array, pivotIndex + 1, end)// Right run quicksort on  array from pivot index +1 to the end of array
